...
How to set up social connection with LinkedIn OpenID Connect
...
![Obtaining the Application ID and Client secret](/docs/images/authentication-providers/linkedin/linkedin1.png)

The last thing you have to do is to enable the * Sign In with LinkedIn using OpenID Connect* product for your OAuth application.

![Enable Sign In with LinkedIn using OpenID Connect product](/docs/images/authentication-providers/linkedin/linkedin2.png)
